...
import { getMoviePath, getMovieThumbnailPath } from "@web-speed-hackathon-2026/client/src/utils/get_path";
...
export const MovieArea = ({ movie }: Props) => {
  return (
    <div
      ...
      data-movie-area
    >
      <PausableMovie src={getMoviePath(movie.id)} thumbnailSrc={getMovieThumbnailPath(movie.id)} />
    </div>
  );
};
